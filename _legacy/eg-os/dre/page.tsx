...
const faqList = [
  ...
  {
    question: 'E meus dados? Ficam seguros?',
    answer: 'Sim. Seus dados são confidenciais. A gente usa apenas para gerar seu relatório e, se quiser, você pode pedir pra excluir tudo após a entrega. Privacidade é coisa séria pra gente.'
  },
  {
      ...
      <section className="py-12">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-center mt-4 text-lg" style={{ color: amareloBaunilha }}>
              Assista ao vídeo e descubra como transformar números em decisões inteligentes
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div
            ...
            style={{
              ...
              borderRadius: 24,
              boxShadow: '0 4px 24px 0 rgba(9,43,27,0.10)',
            }}
          >
            <h2 className="text-2xl font-bold mb-4" style={{ color: verdeMenta }}>
              Seus dados são <span style={{ color: verdeMusgo, fontWeight: 700 }}>confidenciais</span>
            </h2>
            <p className="text-lg mb-6" style={{ color: verdeMusgo, opacity: 0.95 }}>
              Suas informações são usadas apenas para gerar seu relatório. Nossa IA não armazena dados além do necessário, e você pode excluir seus dados a qualquer momento.
            </p>
            <ul className="space-y-3 mb-8">
              <li className="flex items-start gap-2" style={{ color: verdeMusgo }}>
                <Lock className="h-5 w-5 flex-shrink-0 mt-1" style={{ color: verdeMenta }} />
                Se até hoje você evitou ter clareza dos seus números porque não gosta de expor seus dados... aqui você resolve isso com privacidade total.
              </li>
              <li className="flex items-start gap-2" style={{ color: verdeMusgo }}>
                <Lock className="h-5 w-5 flex-shrink-0 mt-1" style={{ color: verdeMenta }} />
                Não precisa contratar consultoria, nem abrir sua conta bancária.
              </li>
              <li className="flex items-start gap-2" style={{ color: verdeMusgo }}>
                <Lock className="h-5 w-5 flex-shrink-0 mt-1" style={{ color: verdeMenta }} />
                Basta preencher o formulário com informações simples — só você vê.
              </li>
              <li className="flex items-start gap-2" style={{ color: verdeMusgo }}>
                <Lock className="h-5 w-5 flex-shrink-0 mt-1" style={{ color: verdeMenta }} />
                O relatório volta prontinho, direto no seu e-mail e WhatsApp, sem exposição, sem reuniões, sem constrangimento.
              </li>
            </ul>
            <div className="flex flex-row items-center justify-center gap-8 mb-6 flex-wrap">
              <div className="flex flex-col items-center gap-1">
                <ShieldCheck className="h-7 w-7" style={{ color: verdeMenta }} />
                <span className="text-sm font-medium" style={{ color: verdeMusgo }}>LGPD</span>
              </div>
              <div className="flex flex-col items-center gap-1">
                <Lock className="h-7 w-7" style={{ color: verdeMenta }} />
                <span className="text-sm font-medium" style={{ color: verdeMusgo }}>Criptografia</span>
              </div>
              <div className="flex flex-col items-center gap-1">
                <Brain className="h-7 w-7" style={{ color: verdeMenta }} />
                <span className="text-sm font-medium" style={{ color: verdeMusgo }}>IA Segura</span>
              </div>
            </div>
      ...
      <section className="py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-8 rounded-2xl transition-all duration-200 shadow-xl hover:shadow-2xl hover:-translate-y-1" style={{ background: amareloBaunilha, color: verdeMusgo, boxShadow: sombraCard, border: bordaCard }}>
              <div className="flex items-center justify-center mb-4">
                <span style={{ background: bgIcone, borderRadius: '50%', padding: 0, display: 'inline-flex', width: 64, height: 64, overflow: 'hidden' }}>
                  <Image
                    src="/images/Farmaceutica.jpg"
                    alt="Foto Luis Carlos"
                    width={64}
                    height={64}
              ...
              <p className="font-medium">Luis Carlos</p>
              <p className="text-sm" style={{ opacity: 0.7 }}>Farmacêutico</p>
            </div>
            <div className="p-8 rounded-2xl transition-all duration-200 shadow-xl hover:shadow-2xl hover:-translate-y-1" style={{ background: '#fff', color: verdeMusgo, boxShadow: sombraCard, border: bordaCard }}>
              <div className="flex items-center justify-center mb-4">
                <span style={{ background: bgIcone, borderRadius: '50%', padding: 0, display: 'inline-flex', width: 64, height: 64, overflow: 'hidden' }}>
                  <Image
                    src="/images/Autopecas.jpeg"
                    alt="Foto Rogerio"
                    width={64}
                    height={64}
                    style={{ objectFit: 'cover', borderRadius: '50%' }}
              ...
              <p className="mb-4">"Fiquei com vergonha de ver como gastava. Nem usava planilha direito, mas agora tá tudo claro."</p>
              <p className="font-medium">Rogerio</p>
              <p className="text-sm" style={{ opacity: 0.7 }}>Autopeças Multimarcas</p>
            </div>
            <div className="p-8 rounded-2xl transition-all duration-200 shadow-xl hover:shadow-2xl hover:-translate-y-1" style={{ background: amareloBaunilha, color: verdeMusgo, boxShadow: sombraCard, border: bordaCard }}>
              <div className="flex items-center justify-center mb-4">
                <span style={{ background: bgIcone, borderRadius: '50%', padding: 0, display: 'inline-flex', width: 64, height: 64, overflow: 'hidden' }}>
                  <Image
                    src="/images/Remoando.jpg"
                    alt="Foto Priscila"
                    width={64}
                    height={64}
                    style={{ objectFit: 'cover', borderRadius: '50%' }}
              ...
              <p className="mb-4">"Meu contador não me falava isso. Agora sei até o lucro por pedido."</p>
              <p className="font-medium">Priscila</p>
              <p className="text-sm" style={{ opacity: 0.7 }}>Ecommerce de Moda Feminina</p>
            </div>
          </div>
        </div>
      </section>
