        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <div className="flex space-x-4">
                <a href="https://instagram.com/agroaiguardian" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors hover-lift">
                ...
                <a href="https://wa.me/5511999999999" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors hover-lift">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              ...
              <div className="space-y-3 text-gray-400">
                <div className="flex items-center space-x-2">
                  ...
                  <a href="mailto:suporte@agroaiguardian.com.br" className="hover:text-white transition-colors">
                    suporte@agroaiguardian.com.br
                  </a>
                </div>
                <div className="flex items-center space-x-2">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400">
              © 2025 Agro AI Guardian. Todos os direitos reservados.
            </div>
            <div className="flex space-x-6 mt-4 md:mt-0">
              <Link href="/agro-ai-guardian/politica-privacidade" className="text-gray-400 hover:text-white transition-colors">
                Política de Privacidade
              </Link>
              <Link href="/agro-ai-guardian/termos-uso" className="text-gray-400 hover:text-white transition-colors">
                Termos de Uso
              </Link>
            </div>
          </div>
