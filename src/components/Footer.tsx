...
export default function Footer() {
  ...
  return (
    <footer className="bg-musgo-deep text-baunilha border-t hairline">
      <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:py-16 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="mt-4 text-sm text-baunilha/60 max-w-sm">
              Consultoria de crescimento comercial e tecnológico para empresas B2B.
            ...
            <div className="mt-6 flex space-x-6">
              <a href="https://github.com/EverGreen-Agency" target="_blank" rel="noopener noreferrer" className="text-baunilha hover:text-menta">
              ...
              <a href="https://www.linkedin.com/company/106525857" className="text-baunilha hover:text-menta">
                <span className="sr-only">LinkedIn</span>
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" />
                </svg>
              </a>
              <a href="https://www.instagram.com/eg.mkt_of/" className="text-baunilha hover:text-menta">
              ...
              <a href="https://wa.me/5511959780701" className="text-baunilha hover:text-menta">
          ...
          {/* Links Rápidos */}
          <div>
            <h3 className="text-sm font-semibold text-baunilha tracking-wider uppercase">
              Empresa
            </h3>
            <ul className="mt-4 space-y-4">
              <li>
                <Link href="/sobre" className="text-baunilha hover:text-menta">
                  Sobre
                </Link>
              </li>
              <li>
                <Link href="/equipe" className="text-baunilha hover:text-menta">
                  Equipe
                </Link>
              </li>
              <li>
                <Link href="/portfolio" className="text-baunilha/70 hover:text-menta">
                  Portfólio
                </Link>
              </li>
              <li>
                <Link href="/autoridade" className="text-baunilha/70 hover:text-menta">
                  Autoridade
                </Link>
              </li>
              <li>
                <Link href="/blog" className="text-baunilha/70 hover:text-menta">
                  Blog
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              <li>
                <Link href="/legal/termos-de-uso" className="text-baunilha hover:text-menta">
                  Termos de Uso
                </Link>
              </li>
              <li>
                <Link href="/legal/privacidade" className="text-baunilha hover:text-menta">
                  Privacidade
                </Link>
              </li>
              <li>
                <Link href="/politicas-de-reembolso" className="text-baunilha hover:text-menta">
                  Reembolso
                </Link>
              </li>
              <li>
                <Link href="/legal/cookies" className="text-baunilha hover:text-menta">
                  Cookies
                </Link>
              </li>
            </ul>
