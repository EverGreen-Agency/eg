  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        {/* Floating elements */}
        <div className="absolute top-1/4 left-1/4 text-4xl opacity-30">⭐</div>
        <div className="absolute top-1/3 right-1/3 text-3xl opacity-30">💖</div>
        <div className="absolute bottom-1/3 left-1/3 text-3xl opacity-30">🎨</div>
        <div className="absolute bottom-1/4 right-1/4 text-4xl opacity-30">🌟</div>
      </div>
